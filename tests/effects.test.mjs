...
function eventFrame(count=1){const frame=new Int32Array(2097+count*8);frame[0]=20;frame[2096]=count;for(let i=0;i<count;i++)frame.set([19,i,0,2,100*65536,200*65536,0,0],2097+i*8);return frame;}
