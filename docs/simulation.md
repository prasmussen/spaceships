...
Projectile slots follow the ships at state offset 192: 256 slots × 32 bytes. Fields are x, y, vx, vy, lifetime, owner, unique sequence ID, and zero reserved word. Inactive slots are entirely zero. Allocation selects the lowest free slot; sequence IDs never wrap. Snapshots validate IDs, uniqueness, lifetime, ownership, velocity and remaining-travel overflow bounds.
