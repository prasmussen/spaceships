...
| Arena has a compact shared layout | 4800 × 3000 world units; 300-unit collision cells; four supported pads and shared landmarks; terrain and pad coordinates scaled to 75% of the previous layout | `tests/arena.test.mjs`, collision-grid/full-scan comparisons, normal-input travel fixtures |
